    ...
    return (
        <div className="cursor-pointer" key={blog.id}>
            <div class="max-w-sm my-3 md:h-[500px] h-[500px] p-2 border border-gray-200 rounded-lg shadow bg-gray-800 dark:border-gray-700">
                ...
                <div class="p-5">
                    <a href="#">
                        <h5 class="mb-2 md:text-2xl text-sm font-semibold font-poppins tracking-tight text-gray-900 dark:text-white">{title}</h5>
                    </a>
    ...
    return (
        <section class="py-10 bg-primary sm:py-3">
            <div class="md:px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex md:flex-row flex-wrap flex-col justify-between items-center w-full">
                    {blogsData.map((blog) => (
