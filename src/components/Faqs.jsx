            ...
            <div class="max-w-5xl px-4 mx-auto sm:px-6 lg:px-8">
                ...
                <div class="flex items-center justify-center mt-12 md:mt-20">
                    <div class="px-8 py-4 text-center bg-gray-800 rounded-full">
                        <p class="text-gray-50">Viatu Care™️ Warning: While using
                            the Ultimate Sneaker Cleaner, please note that we do not
                            accept any responsibility or liability for any damage to
                            your item. Individual outcomes may vary, so use at your
                            own risk. </p>
                    </div>
                </div>
            </div>
