...
import { legs, mobile, nike, shoes } from '../assets';
import Button from './Button';
import ButtonMore from './ButtonMore';

const Mobile = () => {
    return (
        <section id="services" className='flex md:flex-row-reverse flex-col sm:py-6 py-6'>
            <div className="flex-1 flex justify-center items-center md:mr-10 mr-0 md:mt-0 mt-10 relative">
                <img src={mobile} alt="" className='w-[100%] h-[100%] object-contain relative z-[5] rounded-full' />
                <div className="absolute z-[3] -left-1/2 top-0 w-[100%] h-[100%] rounded-full white__gradient "></div>
                <div className="absolute z-[0] -left-1/2 bottom-0 w-[100%] h-[100%] rounded-full pink__gradient "></div>
            </div>
            ...
            <div className="flex-1 flex justify-center items-start flex-col">
                ...
                <div class="flex items-center justify-center">
                    ...
                    <div>
                        ...
                        <div class="flex md:flex-row flex-row w-full gap-2 p-2">
